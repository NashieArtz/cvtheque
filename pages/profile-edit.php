...
<form method="post">
    ...
    <input type="submit" name="submit-competence-modifie" id="profile-edit-modifie-competence" value="Modifier les compétences">
    <label></label>
    ...
    <input type="submit" name="submit-experience-modifie" id="profile-edit-modifie-experience" value="Modifier & Supprimer">
    <label></label>
