                ...
                <div class="card-body p-4 p-md-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-6 text-center text-md-start">
                            ...
                            <p class="profile-grey-text mb-0">@username</p>
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-1 profile-grey-text"><i class="fas fa-envelope me-2"></i> Email : lebgdu76@gmail.com</p>
                            <p class="mb-1 profile-grey-text"><i class="fas fa-phone me-2"></i> Numéro : 06 XX XX XX XX</p>
                            <p class="mb-0 profile-grey-text"><i class="fas fa-key me-2"></i> Mots de passe : ••••••••</p>
                        </div>
                        <div class="col-md-6">
                            <h5 class="fw-bold">Localisation</h5>
                            <p class="mb-1 profile-grey-text"><i class="fas fa-globe-europe me-2"></i> Pays : France</p>
                            <p class="mb-1 profile-grey-text"><i class="fas fa-city me-2"></i> Ville : Rouen</p>
                            <p class="mb-0 profile-grey-text"><i class="fas fa-map-pin me-2"></i> Code Postal : 76570</p>
                        </div>
                    </div>
                </div>
            </div>
